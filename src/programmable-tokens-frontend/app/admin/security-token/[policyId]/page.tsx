...
export default function SecurityTokenAdminPage() {
      ...
      <PageContainer>
        <div className="max-w-4xl mx-auto py-10">
          <Card className="p-6 space-y-2">
            <h1 className="text-lg font-semibold text-white">Not a security-token</h1>
            <p className="text-sm text-dark-300">
              This policy id is not registered as a security-token; admin operations
    ...
    <PageContainer>
      <div className="max-w-4xl mx-auto py-10 space-y-6">
        <div className="space-y-1">
          <h1 className="text-3xl font-bold text-white">Security-Token Admin</h1>
...
function MemberRootHashSection({ policyId }: { policyId: string }) {
  ...
  const refresh = () => {
    getSecurityTokenGlobalState(policyId)
