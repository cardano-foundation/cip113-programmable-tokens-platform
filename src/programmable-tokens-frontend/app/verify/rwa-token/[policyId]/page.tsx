 ...
 *  even when {@code listRwaTokens()} hasn't returned (e.g. on cold load). */
type DisplayToken = Pick<RwaTokenSummary, "policyId" | "assetName" | "displayName" | "description">;
...
export default function VerifyRwaTokenPage() {
  ...
  const { status, refresh } = useRwaTokenMembershipStatus(policyId, walletAddress);
