...
export async function apiGet(endpoint, options) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            throw new ApiException(errorText || `API request failed: ${response.statusText}`, response.status);
        }
        ...
        throw new ApiException(error instanceof Error ? error.message : 'Unknown error occurred', 500, error);
    }
}
/**
 * POST request
