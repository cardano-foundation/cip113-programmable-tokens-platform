...
public class PreviewSeizeTest extends AbstractPreviewTest implements PreviewFreezeAndSieze {
    ...
    public void test() throws Exception {
        ...
        var moduleName = "freeze-and-seize";
...
////            // Programmable Logic Base parameterization
        ...
        var issuerContractOpt = moduleService.getModuleValidator(moduleName, "example_transfer_logic.issuer_admin_contract.withdraw");
...
//        var issuerAdminContractInitParams = ListPlutusData.of(serialize(issuerAdminAccount.getBaseAddress().getPaymentCredential().get()));
        ...
        var moduleIssueAdminContract = PlutusBlueprintUtil.getPlutusScriptFromCompiledCode(
        ...
        var moduleIssueAdminAddress = AddressProvider.getRewardAddress(moduleIssueAdminContract, network);

        var moduleTransferContractOpt = moduleService.getModuleValidator(moduleName, "example_transfer_logic.transfer.withdraw");
        ...
        var moduleTransferContract1 = moduleTransferContractOpt.get();
        ...
        var parameterisedModuleTransferContract = PlutusBlueprintUtil.getPlutusScriptFromCompiledCode(
                AikenScriptUtil.applyParamToScript(transferContractInitParams, moduleTransferContract1.scriptBytes()),
                PlutusVersion.v3
        );

        var moduleTransferAddress = AddressProvider.getRewardAddress(parameterisedModuleTransferContract, network);
        ...
        var tx = new ScriptTx()
                ...
                .withdraw(moduleIssueAdminAddress.getAddress(), BigInteger.ZERO, ConstrPlutusData.of(0))
