 ...
 *
 * <p>{@link DummySubstandardHandler} does not read this file directly; it takes validators
 * from {@code SubstandardService}, which globs {@code classpath:substandards/{@literal *}/plutus.json}.
...
class DummyBlueprintServedSurfaceTest {
    ...
    private static final String SERVED = "/substandards/dummy/plutus.json";
     ...
     * call {@link DummySubstandardHandler} makes — must equal the hash the blueprint declares.
