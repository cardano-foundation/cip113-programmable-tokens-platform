...
public class PreviewBlacklistManagementTest extends AbstractPreviewTest implements PreviewFreezeAndSieze {
    ...
    public void initList() throws Exception {
        ...
        var blackListMintValidatorOpt = moduleService.getModuleValidator(moduleName, "blacklist_mint.blacklist_mint.mint");
        ...
        var blacklistSpendValidatorOpt = moduleService.getModuleValidator(moduleName, "blacklist_spend.blacklist_spend.spend");
