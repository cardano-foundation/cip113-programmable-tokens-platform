...
public class PreviewRegisterTest extends AbstractPreviewTest implements PreviewFreezeAndSieze {
    ...
    public void test() throws Exception {
        ...
        var transferContractOpt = moduleService.getModuleValidator(moduleName, "example_transfer_logic.transfer.withdraw");
        ...
        var moduleTransferContract = PlutusBlueprintUtil.getPlutusScriptFromCompiledCode(
        ...
        // moduleIssueContract is the freeze-and-seize admin script ("Issuer to be
        ...
        var tx = new ScriptTx()
                ...
                // No redeemer for module
                .withdraw(moduleIssueAddress.getAddress(), BigInteger.ZERO, ConstrPlutusData.of(0))
                // Mint Token
