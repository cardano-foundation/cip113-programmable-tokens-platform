 ...
 * The module is resolved from tokenPolicyId via the programmable token registry.
 *
 * @param feePayerAddress  The address that pays for the transaction
 * @param tokenPolicyId    The policy ID of the programmable token (used to resolve module)
