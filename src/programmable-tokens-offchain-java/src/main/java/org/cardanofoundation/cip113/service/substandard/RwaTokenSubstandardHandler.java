...
@Slf4j
public class RwaTokenSubstandardHandler
        implements SubstandardHandler,
                   ...
                   // request with "Substandard 'rwa-token' does not support seize
    ...
    public TransactionContext<List<String>> buildPreRegistrationTransaction(
        ...
        // rwa-token bundles the substandard stake-credential registration into
    ...
    public TransactionContext<RegistrationResult> buildRegistrationTransaction(
        ...
        try {
            ...
            // rwa-token substandard. (The RwaTokenRegistrationEntity
