...
public interface WhitelistManageable {
    ...
    record WhitelistInitRequest(
            /** The policy ID of the programmable token (used to resolve module, optional if moduleId is provided) */
            String tokenPolicyId,
            /** The module ID (e.g., "kyc") - used when token is not yet registered */
            String moduleId,
