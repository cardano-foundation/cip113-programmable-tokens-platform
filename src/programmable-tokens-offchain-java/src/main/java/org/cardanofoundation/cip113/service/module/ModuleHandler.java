...
/**
 * Base interface for handling different programmable token modules.
 *
 * This interface defines the common contract for all module handlers.
 ...
 * <ul>
 *   <li>DummyModuleHandler implements ModuleHandler, BasicOperations</li>
 *   <li>FreezeAndSeizeHandler implements ModuleHandler, BasicOperations, BlacklistManageable, Seizeable</li>
 * </ul>
 */
public interface ModuleHandler {

    /**
     * Returns the unique identifier for this module (e.g., "dummy", "freeze-and-seize")
     */
    String getModuleId();
