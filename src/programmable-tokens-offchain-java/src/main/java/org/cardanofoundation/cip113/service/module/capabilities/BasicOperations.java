...
/**
 * Basic operations capability that all module handlers must implement.
 * Includes: register, mint (and burn), transfer
 *
 * @param <R> The specific registration request type for this module
 */
public interface BasicOperations<R extends RegisterTokenRequest> {

    /**
     * Build registration transaction for this module.
    ...
    /**
     * Build mint transaction for this module.
    ...
    /**
     * Build transfer transaction for this module.
