...
@Entity
@Table(name = "rwa_token_registration")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class RwaTokenRegistrationEntity {
    ...
    /** Hex asset name of the RWA token (mirror of programmable_token_registry.asset_name,
