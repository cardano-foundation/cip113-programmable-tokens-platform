...
@Repository
public interface RwaTokenRegistrationRepository
        extends JpaRepository<RwaTokenRegistrationEntity, String> {

    Optional<RwaTokenRegistrationEntity> findByProgrammableTokenPolicyId(String policyId);

    /** Used by the /admin/tokens endpoint to surface every rwa-token a wallet
    ...
    List<RwaTokenRegistrationEntity> findByIssuerAdminPkh(String issuerAdminPkh);
    ...
    Optional<RwaTokenRegistrationEntity> findByGlobalStatePolicyId(String globalStatePolicyId);
    ...
    @Transactional
    @Query("update RwaTokenRegistrationEntity r set r.cip68ReferenceMinted = true "
