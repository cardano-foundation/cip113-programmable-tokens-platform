package org.cardanofoundation.cip113.service.module.capabilities;

import org.cardanofoundation.cip113.model.TransactionContext;
import org.cardanofoundation.cip113.model.bootstrap.ProtocolBootstrapParams;

/**
 * Global state management capability for modules that use a global state UTxO.
 ...
 *
 * <p>This interface covers all global-state operations for the KYC module.
 * It is intentionally separate from {@link WhitelistManageable}, which is reserved
 * for modules that maintain an on-chain address whitelist (linked-list pattern).</p>
 */
public interface GlobalStateManageable {
    ...
    record GlobalStateInitRequest(
            /** Module ID (e.g., "kyc") — used when the token is not yet registered */
            String moduleId,
