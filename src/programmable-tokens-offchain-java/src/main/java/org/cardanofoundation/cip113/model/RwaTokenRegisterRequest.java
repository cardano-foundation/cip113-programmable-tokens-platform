...
@NoArgsConstructor
@AllArgsConstructor
public class RwaTokenRegisterRequest extends RegisterTokenRequest {
    ...
    /** Initial mintable cap for the rwa-token policy. Decremented on every
     ...
     *  inserts the CIP-113 directory entry and mints no RWA tokens.
     *
