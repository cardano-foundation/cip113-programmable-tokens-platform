...
@Repository
public interface RwaTokenMemberLeafRepository
        extends JpaRepository<RwaTokenMemberLeafEntity, Long> {

    List<RwaTokenMemberLeafEntity> findByProgrammableTokenPolicyId(String policyId);

    /** Only the leaves that have been included in a successful on-chain root publish. */
    @Query("SELECT e FROM RwaTokenMemberLeafEntity e " +
           "WHERE e.programmableTokenPolicyId = :policyId AND e.publishedAt IS NOT NULL")
    List<RwaTokenMemberLeafEntity> findPublishedByProgrammableTokenPolicyId(
    ...
    List<RwaTokenMemberLeafEntity> findByProgrammableTokenPolicyIdAndMemberPkh(
     ...
     *  leaf key). */
    Optional<RwaTokenMemberLeafEntity> findByProgrammableTokenPolicyIdAndMemberPkhAndCredentialType(
    ...
    @Modifying
    @Query("UPDATE RwaTokenMemberLeafEntity e SET e.publishedAt = :publishedAt " +
    ...
    List<RwaTokenMemberLeafEntity> findExpired(
    ...
    @Modifying
    @Query(value = """
        INSERT INTO rwa_token_member_leaf
