...
The generic mint and transfer endpoints select the module using `moduleId` in their JSON data. The backend serves the module catalog at `/modules`. KERI endpoints issue and manage proofs under `/keri/`.
